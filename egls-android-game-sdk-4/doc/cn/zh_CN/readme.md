...
### 3. 环境搭建
#### 3.1 依赖关系
![image](https://github.com/sonicdjgh/egls-android-game-sdk-release-eclipse/blob/master/res/cn/S4CN000.png)<br/>
...
![image](https://github.com/sonicdjgh/egls-android-game-sdk-release-eclipse/blob/master/res/cn/S4CN001.png)
#### 3.3 AGS lib 选择
针对于在港台地区发行的游戏，我们只需要如下图红框所示的lib文件：<br/>
![image](https://github.com/sonicdjgh/egls-android-game-sdk-release-eclipse/blob/master/res/cn/S4CN002.png)<br/>
